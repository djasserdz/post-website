...
<?php $component->withAttributes([]); ?>
    <div class="max-w-md mx-auto bg-white shadow-lg rounded-lg p-6">
        ...
        <form action="<?php echo e(route('post.update',$post)); ?>" method="post" class="space-y-4">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>
            <div class="flex flex-col">
                <label for="title" class="mb-1 font-semibold text-gray-700">title</label>
                <input type="text" name="title" class="p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-slate-800" value="<?php echo e($post->title); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex flex-col">
                ...
                <input type="text" name="body" class="p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-slate-800" value="<?php echo e($post->body); ?>">
...
<?php endif; ?><?php /**PATH C:\Users\gndja\Desktop\Post app\resources\views/post/edit.blade.php ENDPATH**/ ?>